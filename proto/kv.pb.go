...
var fileDescriptor_2216fe83c9c12408 = []byte{
	...
	,
}
...
type KVServiceClient interface {
	...
	Sync(ctx context.Context, opts ...grpc.CallOption) (KVService_SyncClient, error)
}
...
func (c *kVServiceClient) Sync(ctx context.Context, opts ...grpc.CallOption) (KVService_SyncClient, error) {
	stream, err := c.cc.NewStream(ctx, &_KVService_serviceDesc.Streams[0], "/kv.KVService/Sync", opts...)
	if err != nil {
		return nil, err
	}
	x := &kVServiceSyncClient{stream}
	return x, nil
}

type KVService_SyncClient interface {
	Send(*SyncMessage) error
	Recv() (*SyncMessage, error)
	grpc.ClientStream
}

type kVServiceSyncClient struct {
	grpc.ClientStream
}

func (x *kVServiceSyncClient) Send(m *SyncMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *kVServiceSyncClient) Recv() (*SyncMessage, error) {
	m := new(SyncMessage)
...
type KVServiceServer interface {
	...
	//    rpc Subscribe (SubscribeRequest) returns (stream FetchResponse) {}
	Sync(KVService_SyncServer) error
}
...
func (*UnimplementedKVServiceServer) Sync(srv KVService_SyncServer) error {
...
func _KVService_Sync_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(KVServiceServer).Sync(&kVServiceSyncServer{stream})
}

type KVService_SyncServer interface {
	Send(*SyncMessage) error
	Recv() (*SyncMessage, error)
	grpc.ServerStream
}

type kVServiceSyncServer struct {
	grpc.ServerStream
}

func (x *kVServiceSyncServer) Send(m *SyncMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *kVServiceSyncServer) Recv() (*SyncMessage, error) {
	m := new(SyncMessage)
